...
setup(
    name='ComConverter',
    version='',
    packages=['venv', 'venv.Lib.site-packages.serial', 'venv.Lib.site-packages.serial.tools',
              'venv.Lib.site-packages.serial.threaded', 'venv.Lib.site-packages.serial.urlhandler',
              ...
              'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip._internal.operations', 'comConversion'],
    url='',
    license='',
    author='Elliot Rieflin',
    author_email='',
    description=''
)
